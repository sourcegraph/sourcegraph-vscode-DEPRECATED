 ...
 */
 ...
 async function ossSearchCommand(value: string|undefined): Promise<void> {
		if(!value){
			return;
		}
		 await open(
			`https://sourcegraph.com/search?patternType=literal` +
				`&q=${encodeURIComponent(value)}`
		);
}

vscode.commands.registerCommand('extension.ossSearch', () => {
