...
declare namespace SourcegraphGQL {
    ...
    interface IConfigurationSubjectOnQueryArguments {
        id: string
    }
    ...
    interface ISymbolsOnRepositoryArguments {
        /**
    ...
    interface IPackagesOnRepositoryArguments {
        /**
    ...
    interface IDependenciesOnRepositoryArguments {
        /**
    ...
    interface IPackagesOnGitCommitArguments {
        /**
         * Returns the first n packages from the list.
         */
        first?: number | null
    ...
    interface IDependenciesOnGitCommitArguments {
        /**
         * Returns the first n dependencies from the list.
         */
        first?: number | null
    ...
    interface IDependencyReferencesOnGitBlobArguments {
        Language: string
        Line: number
        Character: number
    }
    ...
    interface IDependencyReferencesOnFile2Arguments {
        Language: string
        Line: number
        Character: number
    }

    interface ISymbolsOnFile2Arguments {
        /**
         * Returns the first n symbols from the list.
         */
        first?: number | null
    ...
    interface ILangServerOnSiteArguments {
        language: string
    }
    ...
    interface IActivityOnSiteArguments {
        /**
         * Days of history.
         */
        days?: number | null
    ...
    interface IAddRepositoryOnMutationArguments {
        name: string
    }
    ...
    interface ISetAllRepositoriesEnabledOnMutationArguments {
        enabled: boolean
    }
    ...
    interface IDeleteRepositoryOnMutationArguments {
        repository: string
    }
    ...
    interface IEditConfigurationOnConfigurationMutationArguments {
        /**
    ...
    interface IOverwriteConfigurationOnConfigurationMutationArguments {
        contents?: string | null
    }

    interface ICreateSavedQueryOnConfigurationMutationArguments {
        description: string
        query: string
    ...
    interface IUpdateSavedQueryOnConfigurationMutationArguments {
        id: string
        description?: string | null
        query?: string | null
    ...
    interface IDeleteSavedQueryOnConfigurationMutationArguments {
        id: string
    ...
    interface IEnableOnLangServersMutationArguments {
        language: string
    }

    interface IDisableOnLangServersMutationArguments {
        language: string
    }

    interface IRestartOnLangServersMutationArguments {
        language: string
    }

    interface IUpdateOnLangServersMutationArguments {
        language: string
    }
